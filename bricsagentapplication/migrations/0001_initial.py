    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True)),
                ('universities', models.ManyToManyField(to='bricsagentapplication.University')),
            ],
        ),
        migrations.CreateModel(
            name='Article',
            fields=[
                ...
                ('authors', models.ManyToManyField(to='bricsagentapplication.Author')),
                ('keywords', models.ManyToManyField(to='bricsagentapplication.Keyword')),
                ('universities', models.ManyToManyField(to='bricsagentapplication.University')),
            ],
        ),
    ]
